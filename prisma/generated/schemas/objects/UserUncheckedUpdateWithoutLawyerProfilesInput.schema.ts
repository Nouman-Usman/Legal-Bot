...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutLawyerProfilesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutLawyerProfilesInputObjectSchema = Schema
