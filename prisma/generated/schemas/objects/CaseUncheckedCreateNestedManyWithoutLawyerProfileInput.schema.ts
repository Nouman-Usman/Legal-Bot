...
const Schema: z.ZodType<Prisma.CaseUncheckedCreateNestedManyWithoutLawyerProfileInput> =
  z
    .object({
      create: z
        .union([
...
export const CaseUncheckedCreateNestedManyWithoutLawyerProfileInputObjectSchema =
  Schema
