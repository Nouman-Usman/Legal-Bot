...
const Schema: z.ZodType<Prisma.DocumentCreateNestedManyWithoutUploaderInput> = z
  .object({
    create: z
      .union([
...
export const DocumentCreateNestedManyWithoutUploaderInputObjectSchema = Schema
