...
const Schema: z.ZodType<Prisma.CaseUncheckedUpdateWithoutLawyerProfileInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const CaseUncheckedUpdateWithoutLawyerProfileInputObjectSchema = Schema
