...
const Schema: z.ZodType<Prisma.MessageCreateNestedManyWithoutReceiverInput> = z
  .object({
    create: z
      .union([
...
export const MessageCreateNestedManyWithoutReceiverInputObjectSchema = Schema
