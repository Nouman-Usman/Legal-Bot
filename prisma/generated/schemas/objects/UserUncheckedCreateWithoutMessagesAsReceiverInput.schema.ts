...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutMessagesAsReceiverInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutMessagesAsReceiverInputObjectSchema =
  Schema
