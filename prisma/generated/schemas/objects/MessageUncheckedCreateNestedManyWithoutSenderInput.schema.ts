...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateNestedManyWithoutSenderInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedCreateNestedManyWithoutSenderInputObjectSchema =
  Schema
