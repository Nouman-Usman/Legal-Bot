...
const Schema: z.ZodType<Prisma.OrganizationRoleUncheckedCreateNestedManyWithoutOrganizationInput> =
  z
    .object({
      create: z
        .union([
...
export const OrganizationRoleUncheckedCreateNestedManyWithoutOrganizationInputObjectSchema =
  Schema
