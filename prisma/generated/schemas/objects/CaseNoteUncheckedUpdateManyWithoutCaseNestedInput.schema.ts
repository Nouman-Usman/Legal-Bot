...
const Schema: z.ZodType<Prisma.CaseNoteUncheckedUpdateManyWithoutCaseNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => CaseNoteUpsertWithWhereUniqueWithoutCaseInputObjectSchema,
          ),
          z
            .lazy(
              () => CaseNoteUpsertWithWhereUniqueWithoutCaseInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => CaseNoteUpdateWithWhereUniqueWithoutCaseInputObjectSchema,
          ),
          z
            .lazy(
              () => CaseNoteUpdateWithWhereUniqueWithoutCaseInputObjectSchema,
...
export const CaseNoteUncheckedUpdateManyWithoutCaseNestedInputObjectSchema =
  Schema
