...
import { CaseNoteUpdateManyWithoutAuthorNestedInputObjectSchema } from './CaseNoteUpdateManyWithoutAuthorNestedInput.schema'
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutDocumentsAsUploaderInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    casesAsClient: z
      ...
      .optional(),
    caseNotesAsAuthor: z
      .lazy(() => CaseNoteUpdateManyWithoutAuthorNestedInputObjectSchema)
      .optional(),
    messagesAsSender: z
...
export const UserUpdateWithoutDocumentsAsUploaderInputObjectSchema = Schema
