...
const Schema: z.ZodType<Prisma.CaseNoteUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => CaseNoteUpdateManyWithWhereWithoutAuthorInputObjectSchema),
        z
          .lazy(() => CaseNoteUpdateManyWithWhereWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const CaseNoteUpdateManyWithoutAuthorNestedInputObjectSchema = Schema
