...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithoutCaseNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => MessageUpsertWithWhereUniqueWithoutCaseInputObjectSchema),
        z
          .lazy(() => MessageUpsertWithWhereUniqueWithoutCaseInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => MessageUpdateWithWhereUniqueWithoutCaseInputObjectSchema),
        z
          .lazy(() => MessageUpdateWithWhereUniqueWithoutCaseInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const MessageUpdateManyWithoutCaseNestedInputObjectSchema = Schema
