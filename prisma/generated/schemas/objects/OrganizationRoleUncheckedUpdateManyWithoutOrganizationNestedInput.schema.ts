...
const Schema: z.ZodType<Prisma.OrganizationRoleUncheckedUpdateManyWithoutOrganizationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const OrganizationRoleUncheckedUpdateManyWithoutOrganizationNestedInputObjectSchema =
  Schema
