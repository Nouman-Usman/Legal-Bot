...
const Schema: z.ZodType<Prisma.CaseNoteUncheckedCreateNestedManyWithoutAuthorInput> =
  z
    .object({
      create: z
        .union([
...
export const CaseNoteUncheckedCreateNestedManyWithoutAuthorInputObjectSchema =
  Schema
