...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutCasesAsClientInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const UserUncheckedUpdateWithoutCasesAsClientInputObjectSchema = Schema
