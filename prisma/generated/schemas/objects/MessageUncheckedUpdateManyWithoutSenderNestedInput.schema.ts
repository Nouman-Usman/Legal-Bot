...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateManyWithoutSenderNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => MessageUpdateManyWithWhereWithoutSenderInputObjectSchema,
          ),
          z
            .lazy(
              () => MessageUpdateManyWithWhereWithoutSenderInputObjectSchema,
...
export const MessageUncheckedUpdateManyWithoutSenderNestedInputObjectSchema =
  Schema
