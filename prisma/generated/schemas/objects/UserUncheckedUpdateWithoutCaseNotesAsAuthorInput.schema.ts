...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutCaseNotesAsAuthorInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutCaseNotesAsAuthorInputObjectSchema =
  Schema
