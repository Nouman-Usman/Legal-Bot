...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutDocumentsAsUploaderInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutDocumentsAsUploaderInputObjectSchema =
  Schema
