...
const Schema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutCaseNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => InvoiceUpsertWithWhereUniqueWithoutCaseInputObjectSchema,
          ),
          z
            .lazy(
              () => InvoiceUpsertWithWhereUniqueWithoutCaseInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => InvoiceUpdateWithWhereUniqueWithoutCaseInputObjectSchema,
          ),
          z
            .lazy(
              () => InvoiceUpdateWithWhereUniqueWithoutCaseInputObjectSchema,
...
export const InvoiceUncheckedUpdateManyWithoutCaseNestedInputObjectSchema =
  Schema
