...
const Schema: z.ZodType<Prisma.DocumentUncheckedUpdateManyWithoutCaseNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => DocumentUpsertWithWhereUniqueWithoutCaseInputObjectSchema,
          ),
          z
            .lazy(
              () => DocumentUpsertWithWhereUniqueWithoutCaseInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => DocumentUpdateWithWhereUniqueWithoutCaseInputObjectSchema,
          ),
          z
            .lazy(
              () => DocumentUpdateWithWhereUniqueWithoutCaseInputObjectSchema,
...
export const DocumentUncheckedUpdateManyWithoutCaseNestedInputObjectSchema =
  Schema
