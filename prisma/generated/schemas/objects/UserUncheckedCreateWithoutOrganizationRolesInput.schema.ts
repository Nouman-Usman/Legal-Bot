...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutOrganizationRolesInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutOrganizationRolesInputObjectSchema =
  Schema
