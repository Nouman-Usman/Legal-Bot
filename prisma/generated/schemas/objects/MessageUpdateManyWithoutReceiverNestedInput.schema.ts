...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithoutReceiverNestedInput> = z
  .object({
    create: z
      .union([
...
export const MessageUpdateManyWithoutReceiverNestedInputObjectSchema = Schema
