...
const Schema: z.ZodType<Prisma.CaseUncheckedCreateWithoutLawyerProfileInput> = z
  .object({
...
export const CaseUncheckedCreateWithoutLawyerProfileInputObjectSchema = Schema
