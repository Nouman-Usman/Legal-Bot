...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutCaseNotesAsAuthorInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutCaseNotesAsAuthorInputObjectSchema =
  Schema
