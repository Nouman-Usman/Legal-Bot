...
const Schema: z.ZodType<Prisma.OrganizationRoleUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const OrganizationRoleUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema
