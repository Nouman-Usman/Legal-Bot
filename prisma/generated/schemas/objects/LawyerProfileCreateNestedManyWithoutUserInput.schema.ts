...
const Schema: z.ZodType<Prisma.LawyerProfileCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const LawyerProfileCreateNestedManyWithoutUserInputObjectSchema = Schema
