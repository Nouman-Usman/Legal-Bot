...
const Schema: z.ZodType<Prisma.DocumentUpdateManyWithoutUploaderNestedInput> = z
  .object({
    create: z
      .union([
...
export const DocumentUpdateManyWithoutUploaderNestedInputObjectSchema = Schema
