...
const Schema: z.ZodType<Prisma.OrganizationRoleCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const OrganizationRoleCreateNestedManyWithoutUserInputObjectSchema =
  Schema
