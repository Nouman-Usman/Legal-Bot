...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutOrganizationRolesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutOrganizationRolesInputObjectSchema =
  Schema
