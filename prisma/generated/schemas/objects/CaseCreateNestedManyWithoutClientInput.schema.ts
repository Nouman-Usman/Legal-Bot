...
const Schema: z.ZodType<Prisma.CaseCreateNestedManyWithoutClientInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => CaseUncheckedCreateWithoutClientInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => CaseCreateOrConnectWithoutClientInputObjectSchema),
        z.lazy(() => CaseCreateOrConnectWithoutClientInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
...
export const CaseCreateNestedManyWithoutClientInputObjectSchema = Schema
