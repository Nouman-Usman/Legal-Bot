...
import { CaseNoteUpdateManyWithoutCaseNestedInputObjectSchema } from './CaseNoteUpdateManyWithoutCaseNestedInput.schema'
...
const Schema: z.ZodType<Prisma.CaseUpdateWithoutLawyerProfileInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    invoices: z
      ...
      .optional(),
    caseNotes: z
      .lazy(() => CaseNoteUpdateManyWithoutCaseNestedInputObjectSchema)
      .optional(),
    messages: z
...
export const CaseUpdateWithoutLawyerProfileInputObjectSchema = Schema
