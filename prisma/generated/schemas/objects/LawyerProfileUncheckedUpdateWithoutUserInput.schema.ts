...
const Schema: z.ZodType<Prisma.LawyerProfileUncheckedUpdateWithoutUserInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const LawyerProfileUncheckedUpdateWithoutUserInputObjectSchema = Schema
