...
const Schema: z.ZodType<Prisma.LawyerProfileUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LawyerProfileUpdateManyWithoutUserNestedInputObjectSchema = Schema
