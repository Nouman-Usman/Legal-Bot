...
const Schema: z.ZodType<Prisma.CaseUncheckedUpdateManyWithoutLawyerProfileNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CaseUncheckedUpdateManyWithoutLawyerProfileNestedInputObjectSchema =
  Schema
