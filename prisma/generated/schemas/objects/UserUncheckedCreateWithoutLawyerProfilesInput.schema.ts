...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutLawyerProfilesInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutLawyerProfilesInputObjectSchema = Schema
