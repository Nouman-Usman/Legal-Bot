...
import { DocumentUncheckedUpdateManyWithoutUploaderNestedInputObjectSchema } from './DocumentUncheckedUpdateManyWithoutUploaderNestedInput.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutMessagesAsReceiverInput> =
  z
    .object({
      id: z
        .union([
      ...
      documentsAsUploader: z
        .lazy(
          () =>
            DocumentUncheckedUpdateManyWithoutUploaderNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict()

export const UserUncheckedUpdateWithoutMessagesAsReceiverInputObjectSchema =
  Schema
