...
export const OrganizationUpsertSchema = z.object({
  ...
  create: z.union([
    OrganizationCreateInputObjectSchema,
    OrganizationUncheckedCreateInputObjectSchema,
  ]),
  update: z.union([
    OrganizationUpdateInputObjectSchema,
    OrganizationUncheckedUpdateInputObjectSchema,
  ]),
})
